# addexp-2
## Title: find the sum of the frist n fibonacci numbers
## Source Code:
``` java
 class Fibonacci{
...
# addexp-1
## Title: To insert a substring into a given main string form a given position.
## Source Code:
``` java
import java.util.Scanner;
...
# addexp-3
## Title: To determine the if a given string is a palindrome or not.
## Source Code:
``` java
import java.util.Scanner;
